    ...
    def ScoreHandler(self,result,toplayer,scorechange):
        ...
        if result==1:#胜利
            ...
            if rankingChange<self.ranking:#战胜比自己排名高的人时互换排名
                ...
                rankingChange = 0
                dbarena.updateCharacterArenaInfo(characterId, {'liansheng':self.liansheng})
...
#'''
#    def getfightid(self,characterId):
